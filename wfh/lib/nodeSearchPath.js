/**
 * @Deprecated use `require('../bin/nodePath')()` instead
...
// Insert "dist/links" and "dr-comp-package/node_modules" into node require() search path,
// at the position of after original path of "<project-root>/node_modules".
...
Module._nodeModulePaths = function(from) {
	...
	if (newPaths.some(path => {
		...
		[].splice.apply(newPaths, [appPathIdx + 1, 0].concat(packagePaths));
	}
	return newPaths;
};
...
/**
 * @Deprecated use `require('./config')().nodePath` instead
 */
