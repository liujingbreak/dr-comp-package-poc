...
var log = require('log4js').getLogger('lib.packageMgr.packageManager');
var fs = require('fs');
var Q = require('q');
...
function readPackages() {
	var mainPJson = require('../../' + config().recipeFolder + '/package.json');
	...
	_.forOwn(mainPJson.dependencies, function(version, moduleName) {
		...
		if (!mainPath) {
			log.debug('skip ' + moduleName + ' : ' + mainPath);
			return;
		}
