module.exports = function(yargs) {
	...
	.command('bump', '[-d <package-dir>] [-v major|minor|patch|prerelease] bump version number of all package.json or [-d] only specific package, useful to call this before publishing packages, default is increasing patch number by 1')
	...
	.demand(1)
	.global(['b', 'p', 'l', 'only-js', 'only-css', 'd', 'r', 'v', 'f', 'browser', 'server', 'dir'])
	.help('h').alias('h', 'help')
	.argv;
};
